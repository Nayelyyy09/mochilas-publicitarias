...
const productos = [
  {
    id: 1,
    codigo: "L001",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Arellano",
    imagen: "/imagenes/loncheras/Lonchera Arellano.png",
    rating: 5,
  },
  {
    id: 2,
    codigo: "L002",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Caja Arequipa",
    imagen: "/imagenes/loncheras/Lonchera Caja Arequipa.png",
    rating: 5,
  },
  {
    id: 3,
    codigo: "L003",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Caja Tacka",
    imagen: "/imagenes/loncheras/Lonchera Caja Tacka.png",
    rating: 5,
  },
  {
    id: 4,
    codigo: "L004",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Coca Cola",
    imagen: "/imagenes/loncheras/Lonchera Coca Cola.png",
    rating: 5,
  },
  {
    id: 5,
    codigo: "L005",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Don Pollo",
    imagen: "/imagenes/loncheras/Lonchera Don pollo.png",
    rating: 5,
  },
  {
    id: 6,
    codigo: "L006",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Lona Labrada",
    imagen: "/imagenes/loncheras/Lonchera Lona Labrada.png",
    rating: 5,
  },
  {
    id: 7,
    codigo: "L007",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Lona",
    imagen: "/imagenes/loncheras/Lonchera Lona.png",
    rating: 5,
  },
  {
    id: 8,
    codigo: "L008",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Mitsui Gris",
    imagen: "/imagenes/loncheras/Lonchera Mitsui Gris.png",
    rating: 5,
  },
  {
    id: 9,
    codigo: "L009",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera Mitsui",
    imagen: "/imagenes/loncheras/Lonchera Mitsui.png",
    rating: 5,
  },
  {
    id: 10,
    codigo: "L010",
    categoria: "Loncheras Publicitarias",
    nombre: "Lonchera MVSV",
    imagen: "/imagenes/loncheras/Lonchera MVSV.png",
    rating: 5,
  },
];
        ...
        {productosActuales.map((item) => (
          ...
          <div
            ...
            setSelectedProduct({
              ...
              name: item.nombre,
              code: item.codigo,
              categoryLabel: item.categoria ?? "Lonchera",
              rating: item.rating ?? 5,
              reviews: 8,
              badge: "Nuevo",
              badgeColor: "bg-emerald-500",
              description: "Lonchera publicitaria personalizada.",
